                    ...
                    <div class="uk-card uk-card-default uk-card-small">
                        <div class="uk-card-header uk-card-secondary">
                            <div class="uk-grid uk-grid-small">
                                <div class="uk-width-auto"><h4 class="uk-margin-remove-bottom"><span data-uk-icon="icon: file-edit"></span> <?= $this->lang->line('panel_admin_edit_pages'); ?> - <?= $this->admin_model->getPagesSpecifyName($idlink); ?></h4></div>
                            </div>
                        </div>
                                ...
                                <div class="uk-margin">
                                    ...
                                    <div class="uk-form-controls">
                                        <div class="uk-width-1-1">
                                            <textarea class="tinyeditor" name="page_description" rows="10" cols="80"><?= $this->admin_model->getPagesSpecifyDesc($idlink); ?></textarea>
                                        </div>
                                    </div>
                                </div>
