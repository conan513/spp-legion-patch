...
class Home extends MX_Controller {
    ...
    public function index()
    {
        ...
        else
        {
            ...
            $data = array(
                'fxtitle' => $this->lang->line('nav_home'),
                ...
                'shopTop' => $this->shop_model->getShopTop()->result(),
                //route
                'slide_url' => base_url('assets/images/slides/'),
                'news_url' => base_url('assets/images/news/'),
                'store_url' => base_url('assets/images/store/'),
                //lang
                'home_latest_news' => $this->lang->line('home_latest_news'),
                'button_learn_more' => $this->lang->line('button_learn_more'),
