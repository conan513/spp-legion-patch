...
DELETE FROM `updates` WHERE `name`='2018_05_25_99_world.sql';

DROP PROCEDURE IF EXISTS fixup_2018_05_25_99_world;

DELIMITER ';;'
CREATE PROCEDURE fixup_2018_05_25_99_world() begin
...
DELIMITER ';'
CALL fixup_2018_05_25_99_world();
...
-- restore values broken by 2018_05_25_99_world if it did not cause an error during import
