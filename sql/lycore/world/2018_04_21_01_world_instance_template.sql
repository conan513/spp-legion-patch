...
UPDATE `instance_template` SET `parent`='1220', `script`='instance_black_rook_hold', `allowMount`='1' WHERE (`map`='1501');
...
UPDATE `instance_template` SET `parent`='1669', `script`='instance_the_seat_of_the_triumvirate', `insideResurrection`=1 WHERE (`map`='1753');
