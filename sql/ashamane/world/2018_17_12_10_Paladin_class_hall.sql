...
DELETE FROM `gossip_menu` WHERE (`MenuId`=20006 AND `TextId`=30532) OR (`MenuId`=20005 AND `TextId`=29824);
INSERT INTO `gossip_menu` (`MenuId`, `TextId`, `VerifiedBuild`) VALUES
(20006, 30532, 22996), -- 106448
(20005, 29824, 22996); -- 106447

DELETE FROM `gossip_menu_option` WHERE (`MenuId`=20006 AND `OptionIndex`=1) OR (`MenuId`=20005 AND `OptionIndex`=0);
INSERT INTO `gossip_menu_option` (`MenuId`, `OptionIndex`, `OptionIcon`, `OptionText`, `OptionBroadcastTextId`, `VerifiedBuild`) VALUES
(20006, 1, 28, 'Recruit Silver Hand Templar', 0, 22996),
(20005, 0, 28, 'Do you require a squire?', 0, 22996);


DELETE FROM `npc_text` WHERE `ID` IN (30532 /*30532*/, 29824 /*29824*/);
INSERT INTO `npc_text` (`ID`, `Probability0`, `Probability1`, `Probability2`, `Probability3`, `Probability4`, `Probability5`, `Probability6`, `Probability7`, `BroadcastTextId0`, `BroadcastTextId1`, `BroadcastTextId2`, `BroadcastTextId3`, `BroadcastTextId4`, `BroadcastTextId5`, `BroadcastTextId6`, `BroadcastTextId7`, `VerifiedBuild`) VALUES
(30532, 1, 0, 0, 0, 0, 0, 0, 0, 122519, 0, 0, 0, 0, 0, 0, 0, 22996), -- 30532
(29824, 1, 0, 0, 0, 0, 0, 0, 0, 117227, 0, 0, 0, 0, 0, 0, 0, 22996); -- 29824


UPDATE `creature_template` SET `gossip_menu_id`='20006' WHERE  `entry`=106448;
