...
DELETE FROM `spell_area` WHERE `spell`=49416 AND `area`=4756 AND `quest_start`=14078 AND `aura_spell`=0 AND `teamId`=-1 AND `racemask`=0 AND `gender`=2;
...
VALUES (49416, 4756, 14078, 14099, 0, -1, 0, 2, 3, 74, 11);
